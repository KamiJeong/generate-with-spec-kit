        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
          {certifications.map((cert) => {
            ...
            return (
              ...
              >
                <div className={`flex h-14 w-14 items-center justify-center rounded-full ${cert.bgColor}`}>
                  <Icon className={`h-7 w-7 ${cert.color}`} />
                </div>
                <h3 className={`mt-4 text-xl font-bold ${cert.color}`}>{cert.name}</h3>
