...
const values = [
	...
	},
	{
		...
		title: "안전",
		description:
			"HACCP, FSSC 22000 인증 기반의 철저한 식품 안전 관리를 실천합니다.",
	},
	{
		icon: Heart,
		title: "책임",
			...
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div className="mx-auto max-w-3xl text-center">
					...
					<p className="mt-4 text-gray-600">
						SFood는 최고 품질의 육가공 식품을 통해 사람들의 식탁을 풍요롭게
						하고, 건강하고 지속 가능한 식품 문화를 만들어 나갑니다.
					</p>
					...
					{values.map((value) => {
						...
						return (
							...
							>
								...
								<h3 className="mt-4 text-lg font-semibold text-sfood-dark">
									{value.title}
								</h3>
