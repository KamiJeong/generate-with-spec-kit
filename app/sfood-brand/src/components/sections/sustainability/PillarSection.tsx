...
export function PillarSection({ pillar, reversed = false }: PillarSectionProps) {
  ...
  return (
    <section className={`py-16 ${reversed ? 'bg-sfood-cream' : 'bg-white'}`}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className={`flex flex-col gap-10 lg:flex-row ${reversed ? 'lg:flex-row-reverse' : ''}`}>
          <div className="lg:w-1/3">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h2 className="mt-1 text-2xl font-bold text-sfood-dark">{pillar.title}</h2>
              </div>
            </div>
          ...
          <div className="lg:w-2/3">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {pillar.activities.map((activity) => (
                ...
                >
                  <h3 className="font-semibold text-sfood-dark">{activity.title}</h3>
