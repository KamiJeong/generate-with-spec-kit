import { BookOpen, Clock, Gift, GraduationCap, TrendingUp, Users } from 'lucide-react';
  ...
  return (
    <section className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-3xl font-bold text-sfood-dark">복리후생</h2>
        <p className="mt-4 text-center text-gray-500">SFood 구성원을 위한 특별한 혜택</p>
                ...
                {categoryBenefits.map((benefit) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <h4 className="font-semibold text-sfood-dark">{benefit.title}</h4>
