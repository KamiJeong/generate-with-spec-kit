  ...
  return (
    <section className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-3xl font-bold text-sfood-dark">인재상</h2>
        <p className="mt-4 text-center text-gray-500">SFood가 함께하고 싶은 사람</p>
          ...
          {personas.map((persona) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-4 text-xl font-bold text-sfood-dark">{persona.keyword}</h3>
                <p className="mt-3 text-sm text-gray-500 leading-relaxed">{persona.description}</p>
              </div>
            );
          })}
        </div>
