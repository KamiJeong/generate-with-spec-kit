                  ...
                  >
                    <button
                      ...
                      className={`flex items-center gap-1 text-sm font-medium text-white/90 hover:text-white ${
                        isSupportActive ? 'text-white underline underline-offset-4' : ''
                      }`}
                    >
                      {item.label}
          ...
          <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent side="right">
                <SheetHeader>
                  <SheetTitle className="text-sfood-red">{siteConfig.name}</SheetTitle>
                </SheetHeader>
                        ...
                        <div key={item.href}>
                          <button
                            ...
                            className={`flex w-full items-center justify-between py-2 text-sm font-medium ${
                              isSupportActive ? 'text-sfood-red' : 'text-gray-700'
                            }`}
                          >
                            {item.label}
                            <ChevronDown
